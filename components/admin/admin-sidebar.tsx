...
import { BookOpen, Video, Upload, CreditCard, Home, LogOut, Users, ClipboardList } from "lucide-react"
...
const navItems = [
  ...
  { href: "/admin/questionnaire", label: "Readiness Quiz", icon: ClipboardList },
]
